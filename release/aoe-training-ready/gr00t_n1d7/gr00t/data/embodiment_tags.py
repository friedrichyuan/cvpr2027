...
class EmbodimentTag(Enum):
    ...
    HUMAN_EGO_BIMANUAL_GRIPPER = "human_ego_bimanual_gripper_relative_eef"
    """
    Human egocentric bimanual gripper (20D EEF-first layout: [left_wrist_eef(9), right_wrist_eef(9), left_gripper(1), right_gripper(1)]).
    AoE data with parallel gripper retargeting. No pretrained projector — trains from scratch.
    """
...
FINETUNE_ONLY_TAGS: frozenset[EmbodimentTag] = frozenset(
    {
        ...
        EmbodimentTag.HUMAN_EGO_BIMANUAL_GRIPPER,
    }
)
