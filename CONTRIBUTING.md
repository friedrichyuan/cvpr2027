...
如果你的贡献引入了新的第三方依赖，请在 `LEGAL.md` 中添加相应条目，说明：
- 依赖名称和用途
- 许可证类型
- 来源（URL 或 pip 包名）
...
**问题描述**：某贡献者将一个完整的独立项目（H-RDT）直接复制到仓库中，覆盖了 `README.md`、`CLAUDE.md`，删除了 `STORY.md`、`PROJECT.md`、`report/` 和 `inner/` 目录。
