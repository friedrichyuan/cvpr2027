...
│   └── retarget-lab/        ← [Retarget Lab](aoe-retarget-replay/retarget-lab/) (EgoInfinity / Do-as-I-Do / SPIDER)
...
| [**EgoInfinity**](aoe-retarget-replay/retarget-lab/) | Object 6-DoF 重建 + G1 retargeting，作为 Retarget Lab 的完整链路之一 | 🧪 实验集成 | [@jiadong5](https://github.com/jiadong5) |
| [**Do as I do**](aoe-retarget-replay/retarget-lab/) | Object/hand 重建适配 + 官方 retargeting 入口 + Sharpa/MJWP 渲染 | 🧪 实验集成 | [@jiadong5](https://github.com/jiadong5) |
| [**SPIDER**](aoe-retarget-replay/retarget-lab/) | XHand/MJWP retargeting 后端，可接入 Retarget Lab 的 12-cell 对比矩阵 | 🧪 实验集成 | [@jiadong5](https://github.com/jiadong5) |
...
# Retarget Lab 对比矩阵 (EgoInfinity / Do-as-I-Do / SPIDER)
cd aoe-retarget-replay/retarget-lab
# 详见 README.md
```
